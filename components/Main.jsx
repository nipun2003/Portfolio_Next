  ...
  return (
    <div className="w-full h-screen text-center py-20">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          <p className="uppercase text-sm tracking-widest text-colorGrayOnBackground">
            Let&apos;s build something together
          </p>
          <h1 className="tracking-wide py-4 text-colorGrayOnBackground">
            Hi, I&apos;m{" "}
            <span className="text-colorPrimary">{profile.name}</span>
          </h1>
          <h1 className="tracking-wide py-2 text-colorGrayOnBackground">
            {profile.main.heading}
          </h1>
          <p className="text-colorGrayOnBackground max-w-[70%] m-auto">
            {profile.main.sub_heading}
          </p>
