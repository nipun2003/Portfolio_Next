...
const Nabar = () => {
  ...
  return (
    <div className="fixed w-full h-20 shadow-xl z-[100]">
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <div className="">
          <ul className="hidden md:flex ">
            ...
            <Link href="/hire">
              <li className="ml-10 text-sm uppercase hover:border-b">Hire Me</li>
            </Link>
          </ul>
      ...
      <div className={nav ? "md:hidden fixed left-0 top-0 w-full h-screen bg-[#2b2b2b]/80" : ""}>
        <div className={nav ?
          ...
          <div className="">
            <div className="flex w-full items-center justify-between">
              ...
              <div onClick={handleNavFunction} className="rounded-full shadow-lg shadow-colorShadow p-3 cursor-pointer">
                <AiOutlineClose />
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between space-y-20 ">
            ...
            <div className="">
              <p className="uppercase tracking-widest text-colorPrimary">Let&apos;s Connect</p>
